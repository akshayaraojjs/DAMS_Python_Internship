...
def student_list(request):
    # By using Django ORM, we don't need to write longer SQL queries
    # Django ORM - Object Relational Mapping
    # Django ORMs used: all(), save(), is_valid(), get_object_or_404()
...
def enrollment_add(request):
    ...
    return render(request, 'core/create_enrollment.html', {'form': form})
